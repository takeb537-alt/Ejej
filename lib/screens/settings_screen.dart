...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget _buildBottomBar() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _bottomIcon(Icons.local_hospital_outlined, const Color(0xFFDBEAFF)),
          ...
          _bottomIcon(
              Icons.business_center_outlined, const Color(0xFFFFF3D0)),
        ],
      ),
    );
  }
  ...
  void _showPermissionsDialog(BuildContext context) {
    showDialog(
      context: context,
      builder: (_) => const _PermissionsDialog(),
    );
  }
...
class _PermissionsDialogState extends State<_PermissionsDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          _permRow('Camera', _camera, (v) => setState(() => _camera = v)),
          _permRow('Location', _location,
              (v) => setState(() => _location = v)),
          _permRow('Notifications', _notifications,
              (v) => setState(() => _notifications = v)),
          _permRow('Storage', _storage,
  ...
  Widget _permRow(String label, bool val, Function(bool) onChange) {
    return Row(
...
class _NotifPrefsSheetState extends State<_NotifPrefsSheet> {
  ...
  Widget _notifRow(String label, bool val, Function(bool) onChange) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Text(label, style: const TextStyle(fontSize: 14)),
